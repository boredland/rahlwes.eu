...
import type { TranslationFunction, TranslationFunctionArgs, TranslationKeys } from 'translations'
...
export const useTranslations = (lng: Locale = 'de') => {
  return <Key extends TranslationKeys>(...args: TranslationFunctionArgs<Key>) => {
